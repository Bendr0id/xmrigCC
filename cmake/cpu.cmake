...
if (NOT ARM_TARGET)
    if (APPLE AND CMAKE_OSX_ARCHITECTURES)
        if (CMAKE_OSX_ARCHITECTURES MATCHES "^(arm64|ARM64)$")
            set(ARM_TARGET 8)
        elseif (CMAKE_OSX_ARCHITECTURES MATCHES "^(armv7|armv7f|armv7s|armv7k|armv7-a|armv7l|armv7ve|armv8l)$")
            set(ARM_TARGET 7)
        endif()
    endif()

    if (NOT ARM_TARGET AND NOT (APPLE AND CMAKE_OSX_ARCHITECTURES))
