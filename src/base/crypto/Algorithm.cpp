...
const char* Algorithm::kRX_PCOIN        = "rx/pcoin";
#endif
...
#   ifdef XMRIG_ALGO_CN_FEMTO
    ALGO_ALIAS_AUTO(CN_UPX2),       ALGO_ALIAS(CN_UPX2,         "cryptonight/upx2"),
                                    ...
                                    ALGO_ALIAS(CN_UPX2,         "cn-extremelite"),
#   endif
...
#   ifdef XMRIG_ALGO_RANDOMX
    ...
    ALGO_ALIAS_AUTO(RX_PCOIN),      ALGO_ALIAS(RX_PCOIN,        "randompcoin"),
                                    ALGO_ALIAS(RX_PCOIN,        "randomx/pcoin"),
...
std::vector<xmrig::Algorithm> xmrig::Algorithm::all(const std::function<bool(const Algorithm &algo)> &filter)
{
    static const std::vector<Id> order = {
        ...
        CN_UPX2,
        CN_GPU,
        RX_0, RX_V2, RX_WOW, RX_ARQ, RX_GRAFT, RX_SFX, RX_YADA, RX_XDAG, RX_TUSKE, RX_XEQ, RX_VRL, RX_SCASH, RX_PCOIN,
